 ...
 class ParkedCar {
	...
	class ParkingTicket {
		...
		public String toString() {
			return "ParkingTicket statistics\nCar: " + car + "\nOfficer:" + officer
					+ "\nFine:" + fine + "\nMinutes:" + minutes
					+ "\nBase Fine:" + BASE_FINE + "\n Hourly Fine:"
					+ HOURLY_FINE ;
		}
	...
	public static void main(String[] args) {
		...
		ParkedCar car = parkingTicket.new ParkedCar("Ferrari 125S", "1947",
				"red", "YaBaDU", 125);

		ParkingMeter meter = parkingTicket.new ParkingMeter(60);

		PoliceOfficer officer = parkingTicket.new PoliceOfficer(
				"Connor", "6573");
